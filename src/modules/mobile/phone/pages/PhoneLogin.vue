<template>
  <section
    class="relative flex min-h-screen items-center justify-center overflow-hidden bg-[linear-gradient(180deg,#eff6ff_0%,#e0f2fe_46%,#f8fafc_100%)] px-4 py-6"
  >
    <div
      class="pointer-events-none absolute -left-14 top-[-72px] h-[220px] w-[220px] rounded-full bg-sky-600/20 blur-[28px]"
    ></div>
    <div
      class="pointer-events-none absolute -bottom-20 right-[-72px] h-[220px] w-[220px] rounded-full bg-cyan-400/20 blur-[28px]"
    ></div>

    <div
      class="relative z-10 w-full max-w-[380px] overflow-hidden rounded-[28px] bg-white shadow-[0_24px_60px_rgba(15,23,42,0.14)]"
    >
      <div class="bg-[linear-gradient(135deg,#0369a1_0%,#0ea5e9_100%)] px-5 py-[22px] text-white">
        ...
        <p class="m-0 text-sm leading-6 text-white/90">
          Scan employee barcode to sign in on mobile
        </p>
      </div>

      <div class="grid gap-4 px-5 py-5">
        <div
          class="rounded-[20px] border border-sky-100 bg-[linear-gradient(180deg,#f0f9ff_0%,#eff6ff_100%)] px-4 py-[14px]"
        >
          <p class="mb-[6px] text-xs font-bold uppercase tracking-[0.08em] text-sky-700">
            Employee scan
          </p>
        ...
        <div
          v-if="scannedCode"
          class="rounded-[20px] border border-cyan-100 bg-white px-4 py-4 shadow-sm"
        >
          <p class="mb-1 text-xs font-bold uppercase tracking-[0.08em] text-cyan-700">
            Scanned code
          </p>
