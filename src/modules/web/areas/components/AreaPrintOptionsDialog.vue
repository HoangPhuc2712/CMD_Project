...
import type { CheckpointRow, RoleOption } from '@/modules/web/checkpoints/checkpoints.types'
import { fetchCheckpointRows, fetchRoleOptions } from '@/modules/web/checkpoints/checkpoints.api'
import {
