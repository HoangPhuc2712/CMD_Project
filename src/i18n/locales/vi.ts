const vi = {
  ...
  patrolSummaryReportList: {
    ...
    missedPatrolCount: 'Số Lần Không Tuần Tra',
    timeProblemCount: 'Số lỗi thời gian',
    tooFastPatrolCount: 'Số Lần Tuần Tra Quá Nhanh',
    tooSlowPatrolCount: 'Số Lần Tuần Tra Quá Chậm',
    insufficientNumberOfPatrol: 'Số Lần Tuần Tra Sót Điểm',
    shiftProblemCount: 'Số Lần Tuần Tra Không Theo Lộ Trình',
